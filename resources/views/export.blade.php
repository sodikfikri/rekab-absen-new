...
<div class="content-wrapper">
    ...
    <div class="card card-hover">
        <div class="card-header">
            <small style="color: #e52920;">* Jika ada absensi karyawan yang nilainya 0 itu berarti dia absen masuk dan absen pulang di jam & menit yang sama.</small>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-control" name="years" id="years">
                                            @php
                                                ...
                                                $now = date("Y");
                                                for($year = date("Y", strtotime('+1 years')); $year>=$end; $year--){
                                                    $selected = ($year == $now) ? 'selected' : '';
